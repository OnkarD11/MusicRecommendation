...
class MusicPlayer:
  ...
  def __init__(self,root):
    self.root = root
    # Title of the window
    self.root.title("neutral Music Player")
    # Window Geometry
    ...
    songsframe = LabelFrame(self.root,text="Neutral Song Playlist",font=("times new roman",15,"bold"),bg="grey",fg="white",bd=5,relief=GROOVE)
