...
class MusicPlayer:
  ...
  def __init__(self,root):
    self.root = root
    # Title of the window
    self.root.title("happy music Player")
    # Window Geometry
    ...
    songsframe = LabelFrame(self.root,text="Happy Song Playlist",font=("times new roman",15,"bold"),bg="grey",fg="white",bd=5,relief=GROOVE)
